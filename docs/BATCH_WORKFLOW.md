...
|---|---|---|---|
| Part 1 | 1 scenario x 1 condition x 100 seeds | `outputs/source_results/part1_validation_n100/` | Completed/frozen |
| Part 2 | 2 scenarios x 4 conditions x 100 seeds | `outputs/source_results/part2_spatial_interventions_n100/` | Completed/integrity PASS |
...
```bash
python3 scripts/validation/verify_part2_spatial_interventions.py \
  --batch-dir outputs/source_results/part2_spatial_interventions_n100 \
  --expected full

python3 scripts/build/build_part2_figures_tables.py
```
